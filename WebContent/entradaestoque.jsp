...
String codigo = request.getParameter("codigoentrada");
Estoque estoqueSelecionado = null;
Integer quantidade = Integer.parseInt(request.getParameter("quantidadeentreada"));
...
estoqueDAO.entradaQuantidade(estoqueSelecionado, quantidade);
%>
